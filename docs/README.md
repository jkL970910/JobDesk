...
|----------|------|--------|
| `prd.md` | Product requirements, scope, personas, success metrics | Signoff candidate |
| `design-doc.md` | Authoritative system-level architecture and cross-cutting design | Signoff candidate |
