...
Latest implementation commit: `Add Evidence Library Builder MVP`
...
| 3 | Evidence and project review for resume use | Done, basic | Passed | Supports evidence approve/reject/edit, project card approve/reject/edit, safe project-linked evidence approval, and resume-eligible evidence filtering. Merge/dedupe UX remains later. |
...
| S3 | Vercel deployment path | Done, needs redeploy after Evidence Builder | Previous production deployment and smoke test passed at `https://jobdesk-tau.vercel.app`; the newest Evidence Library Builder changes are locally verified but not redeployed yet. |
...
- Tailored resume: passed, 4 generated claims and 6 missing-evidence questions persisted.
...
| Latest Evidence Builder production deploy | Not run after this change |
...
- Evidence Library Builder MVP is implemented for project-note enrichment and project-card review. STAR story promotion, dedupe/merge, de-identification review, and embedding RAG are not complete yet.
...
| P1 | Redeploy latest baseline to Vercel and re-run production smoke | Needs rerun after Evidence Builder |
