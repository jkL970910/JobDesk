...
export function buildProfileEvidenceInstructions(
  ...
  return composeSkillPrompt(getProfileEvidenceSkillForSource(sourceKind), [
    ...
    "work_experiences must stay high-level: employer, role_title, team, location, dates, and at most one short role-scope summary sentence.",
    "Do not copy resume bullets, metrics, project names, implementation details, action/result claims, or achievement paragraphs into work_experiences.employer, work_experiences.role_title, or work_experiences.summary.",
    "Detailed bullets and achievements belong in initiatives and evidence_items, not Work Experience summaries.",
    ...
    "Put service/domain context into context/problem. Create separate initiatives for distinct named projects, business problems, systems, ownership scopes, or outcomes.",
    ...
    "Bad initiative merge: NFC Check-In Platform, Cross-Team & Operational Excellence, Infrastructure Modernization, Package Return Workflow Enhancement, and Business-Critical Service Region Migration are distinct named initiatives unless the source explicitly states they are one program.",
