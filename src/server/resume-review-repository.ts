  ...
  if (stepKind === "assess_section") {
    ...
    await completeResumeReviewStep(args.db, {
      resultJson: {
        ...
        fallback: assessment.metadata.fallback,
        providerTimedOut: assessment.metadata.providerTimedOut,
        provisional: assessment.metadata.provisional,
        retryCount: assessment.retryCount,
        subchunkCount: assessment.metadata.subchunkCount,
        subchunkRecoveryAttempted: assessment.metadata.subchunkRecoveryAttempted,
